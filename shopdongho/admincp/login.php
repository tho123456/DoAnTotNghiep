...
<form id="login-form" method="POST" action="login-authentication.php">
   <fieldset>
			...
			<legend><h1><font color="#367517">Đăng nhập quản trị</font></h1></legend>
			<center><table width="304" border="0" >
			  <tr>
			    <td><label for="login"><font color="#367517">Tên đăng nhập:</font></label></td>
			    <td><input type="text" id="user" name="user" /></td>
		      </tr>
			  <tr>
			    <td><label for="password2"><font color="#367517">Mật khẩu:</font></label></td>
